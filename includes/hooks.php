...
// Sections
add_action( 'wp_user_profiles_add_meta_boxes',             'wp_user_profiles_add_status_metabox',         10, 2 );
add_action( 'wp_user_profiles_add_profile_meta_boxes',     'wp_user_profiles_add_profile_meta_boxes',     10, 2 );
add_action( 'wp_user_profiles_add_account_meta_boxes',     'wp_user_profiles_add_account_meta_boxes',     10, 2 );
add_action( 'wp_user_profiles_add_options_meta_boxes',     'wp_user_profiles_add_options_meta_boxes',     10, 2 );
add_action( 'wp_user_profiles_add_permissions_meta_boxes', 'wp_user_profiles_add_permissions_meta_boxes', 10, 2 );
